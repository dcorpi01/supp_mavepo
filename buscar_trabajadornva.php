...
<header>
	...
	<section id="container">
        ...
        ?>
		<h1>Usuarios</h1>
        <a href="trabajador_crgnva.php" class="btn_new">Dar de Alta Trabajador</a>
        ...
        <table>
            <tr>
                ...
                <?php 
                    ...
                    $sql_register = mysqli_query($conn, "SELECT COUNT(*) AS total_registro FROM trabcarganova WHERE (id_tb LIKE '%$busqueda%' OR apep LIKE '%$busqueda%' OR tipoem LIKE '%$busqueda%' OR apem LIKE '%$busqueda%' $emp) AND status = 1");
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="link_edit" href="editar_trabajadornva.php?id=<?php echo $data["id_tb"] ?>">Editar</a>
