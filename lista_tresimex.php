...
<header>
	...
	<section id="container">
		<h1>Trabajadores RESIMEX</h1>
        <a href="trabajador_rmx.php" class="btn_new">Alta de trabajador</a>
                ...
                <?php 
                    ...
                    ?>
                        <tr style="">
                            ...
                            <td>
                                <a class="link_edit" href="editar_trabajadormx.php?id_tb=<?php echo $data["id_tb"] ?>">Editar</a>
