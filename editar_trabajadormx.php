...
session_start();
    ...
    if(!empty($_POST)){
        ...
        if(empty($_POST['id_tb']) || empty($_POST['nombre']) || empty($_POST['apep']) || empty($_POST['apem']) || empty($_POST['dptto']) || empty($_POST['curp']) || empty($_POST['ec']) || empty($_POST['nss']) || empty($_POST['rfc']) || empty($_POST['calle']) || empty($_POST['numext']) || empty($_POST['col']) || empty($_POST['cp']) || empty($_POST['muni']) || empty($_POST['hr']) || empty($_POST['fechain']) || empty($_POST['edad'])){
            ...
            $query2 = mysqli_query($conn, "SELECT * FROM trabajadormx WHERE (apep = '$apep' AND id_tb != '$idtb')");
            ...
            if($result2 > 0){
                ...
                if(empty($_POST['apep'])){
                    ...
                    $query8 = mysqli_query($conn, "UPDATE trabajadormx SET apem = '$apem', nombre = '$nombre', curp = '$curp', puesto = '$puesto', ec = '$ec', nss = '$nss', calle = '$calle', numext = '$numext', col = '$col', cp = '$cp', muni = '$muni', hr = '$hr', fechain = '$fechain', edad = '$edad' WHERE id_tb = $idtb");

                }else{

                    $query8 = mysqli_query($conn, "UPDATE trabajadormx SET apep = '$apep', apem = '$apem', nombre = '$nombre', curp = '$curp', rfc = '$rfc', puesto = '$puesto', ec = '$ec', nss = '$nss', calle = '$calle', numext = '$numext', col = '$col', cp = '$cp', muni = '$muni', hr = '$hr', fechain = '$fechain', edad = '$edad' WHERE id_tb = $idtb");
...
<head>
    ...
    <link rel="stylesheet" href="css/resimex.css">
