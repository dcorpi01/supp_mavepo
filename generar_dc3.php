...
<head>
    ...
    <title>Generar DC3 | RESIMEX</title>
    ...
    <script src="dc3_resimex.js"></script>   
</head>
<body>
<header>
		<div class="header">
    ...
    <div class="form_register">
        ...
        <div class="alert"><?php echo isset($alert) ? $alert : ''; ?></div>
            ...
            <form id="form">
                ...
                <input type="text" name="razon" id="razon" value="Residuos Mexicanos SA de CV">

                <label for="rfc">Registro Federal de Contribuyentes con Homoclave <span style="font-weight: bold;">(SHCP): </span></label>
                <input type="text" name="rfc" id="rfc" value="RME 050128 2K9">
