...
include "db.php";
    if(!empty($_POST)){
        ...
        $query10 = mysqli_query($conn, "UPDATE trabajadormx SET status = 0 WHERE id_tb = $idusuario");
    ...
    if(empty($_REQUEST['id_tb']) || $_REQUEST['id_tb'] == 1){
        ...
        $query9 = mysqli_query($conn, "SELECT t.apep, t.apem, t.nombre, t.curp, t.puesto, t.nss, t.col, t.fechain, d.descripcion FROM trabajadormx t INNER JOIN departamentos d ON d.id = t.dptto WHERE t.id_tb = $idusuario");
	...
	<section id="container">
		<div class="data_delete">
            ...
            <form action="" method="POST">
                ...
                <a class="btn_cancel" href="lista_tresimex.php">Cancelar</a>
