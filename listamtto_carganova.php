...
<header>
		<div class="header">
			...
			<h1>ÁREA MANTENIMIENTO | CARGANOVA</h1>
	...
	<section id="container">
		<h1>Trabajadores Mantenimiento | CARGANOVA</h1>
        ...
        <table>
            <tr>
                ...
                <?php 
                    ...
                    $query5 = mysqli_query($conn,"SELECT t.id_tb, t.apep, t.apem, t.nombre, d.descripcion, t.curp, t.puesto, t.nss, t.rfc, t.muni, t.hr, t.tipoem, t.fechain, t.fechanac, d.id FROM trabcarganova t INNER JOIN departamentos d ON d.id = t.dptto WHERE status = 1 AND id = 5 ORDER BY t.id_tb ASC LIMIT $desde,$por_pagina");
                    mysqli_close($conn);
